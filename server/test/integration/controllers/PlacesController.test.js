...
describe('PlacesController', function () {
  ...
  describe('#autosuggest()', function () {
    it('It should return an array of predictions', function (done) {
      request(sails.hooks.http.app)
        .get('/api/places/autosuggest')
        .query({input: 'KFC', radius: '500'})
        .expect(200)
        .end(function (err, res) {
          assert.isArray(res.body.data, "Response from google autosuggestions api is an array");
          done();
        });
    });
  });
